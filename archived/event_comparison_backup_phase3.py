...
def compute_event_to_event_similarity(event_A: Dict[str, object], 
    ...
    # Phase 2: embedding 0.3 : lexical 0.15 : topic 0.55 (最適化: Topic重視)
    if embedding_sim is not None:
        combined_score = embedding_sim * 0.30 + lexical_sim * 0.15 + topic_jaccard * 0.55
...
def main():
    ...
    if not event_pairs_df.empty:
        ...
        print(f"  [OK] Weight adjusted: embedding 0.3 : lexical 0.15 : topic 0.55 (Phase 2 optimized)")
